...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { cupo_max: @curso.cupo_max, cupo_min: @curso.cupo_min, id_materia: @curso.id_materia, nombre: @curso.nombre, num_creditos: @curso.num_creditos } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { cupo_max: @curso.cupo_max, cupo_min: @curso.cupo_min, id_materia: @curso.id_materia, nombre: @curso.nombre, num_creditos: @curso.num_creditos } }
